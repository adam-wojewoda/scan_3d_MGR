...
if platform.system()=='Windows':
    ...
    #lib = cdll.LoadLibrary("/home/pi/___MGR_codes/scan_3d_MGR/RF_627/RF62X-SDK/build/RF62X-Wrappers/Python/lib"+dll_name_no_ext+".so")
    
    lib = cdll.LoadLibrary(os.path.dirname(__file__)+ "/lib"+dll_name_no_ext+".so")
